...
contains  
  ...
  !$$$
    ...
    use obsmod, only   : if_model_dbz,if_staticB_3d,loghydro,lh,lv,iseed,pert_dBZ_sd
...
!      rmse_var='LANDMASK'
      ...
      if( dbz_exist .and. if_model_dbz ) then
          ...
          !                              iseed,lh,lv,one_single/rdx,one_single/rdy,ht,10.0)
  ...
  !$$$ end documentation block
    ...
    use control_vectors, only : w_exist, dbz_exist
    use obsmod, only   : if_model_dbz, loghydro, hydro_noise
