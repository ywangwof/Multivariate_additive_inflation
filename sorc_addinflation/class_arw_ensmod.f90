module abstract_get_arw_ensmod_mod
  type, abstract :: abstract_get_arw_ensmod_class
  contains
  ...
  end type abstract_get_arw_ensmod_class
  ...
  subroutine get_user_ens_(this,grd,ntindex,atm_bundle,iret)
    ...
    import abstract_get_arw_ensmod_class
    implicit none
    class(abstract_get_arw_ensmod_class), intent(inout) :: this
...
end module abstract_get_arw_ensmod_mod
