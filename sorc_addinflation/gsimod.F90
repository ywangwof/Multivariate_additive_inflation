...
! !USES:
  ...
  use obsmod, only: doradaroneob,oneoblat,oneoblon,oneobheight,oneobvalue,oneobddiff,oneobradid,&
     ...
     rmesh_vr,zmesh_dbz,zmesh_vr,if_vterminal, if_model_dbz,hydro_noise,&
     ...
     if_staticB_3d,vordiv_cv,q_cv,uv_cv,loghydro,bintype,lh,lv,iseed,pert_dBZ_sd
  ...
  use hybrid_ensemble_parameters,only : l_hyb_ens,uv_hyb_ens,aniso_a_en,generate_ens,&
                         ...
                         l_ens_in_diff_time,ensemble_path,adaptive_hybrid
...
!            add use of guess file later for regional mode.
  ...
  namelist/setup/gencode,factqmin,factqmax,clip_supersaturation, &
       ...
       if_model_dbz,obs_dep_loc,if_staticB_3d,vordiv_cv,q_cv,uv_cv,loghydro,&
       bintype,lh,lv,iseed,pert_dBZ_sd,hydro_noise
...
!                         
  namelist/hybrid_ensemble/l_hyb_ens,uv_hyb_ens,q_hyb_ens,aniso_a_en,generate_ens,n_ens,nlon_ens,nlat_ens,jcap_ens,&
                ...
                i_en_perts_io,l_ens_in_diff_time,ensemble_path,adaptive_hybrid
