...
! set subroutines and functions to public
  ...
  public :: lh,lv,iseed,pert_dBZ_sd,hydro_noise
  ...
  ! --- DBZ DA ---
  public :: if_staticB_3d
  public :: vordiv_cv, q_cv, uv_cv, bintype, loghydro
...
! Declare global variables
  ...
  logical :: if_staticB_3d, vordiv_cv, q_cv, uv_cv, loghydro,hydro_noise
  integer :: iseed
  real(r_single) :: lh,lv,pert_dBZ_sd
  integer(i_kind) :: bintype
