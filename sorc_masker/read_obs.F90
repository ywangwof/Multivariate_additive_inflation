...
!            Process radar reflectivity from MRMS
                ...
                if(trim(infile)=='dbzobs.nc')then
                  ...
                  string='READ_dBZ'
                else if( trim(infile)== 'refl_vol' )then
                  call read_dbz(nread,npuse,nouse,infile,lunout,obstype,twind,sis,hgtl_full,nobs_sub1(1,i),hlocal(i),vlocal(i))
                  string='READ_dBZ_ASCII'
                else
